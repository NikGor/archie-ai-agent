...
async def climate_control_tool(
    ...
    """
    logger.info(f"climate_control_tool_001: Controlling device \033[36m{device_id}\033[0m")
    logger.info(f"climate_control_tool_002: Action: \033[33m{action}\033[0m, temp: \033[33m{temperature}\033[0m, mode: \033[33m{mode}\033[0m")
